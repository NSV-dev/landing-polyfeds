const translations = {
  ...
  ru: {
    ...
    "projects.day.solution": "Кампания значительно расширила охват бренда благодаря промо, контенту и интерактивным механикам. Гибкая архитектура KV помогла привлечь новую аудиторию, сохранив целостность и консистентность бренда.",
